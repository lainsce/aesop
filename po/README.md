# How to Translate Aesop

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/lainsce/aesop```
...
And that's it! You've successfully translated Aesop for your language!
